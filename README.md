...
**[Real Estate Market Intelligence Dashboard](https://github.com/Rahdin/Calgary_Housing_Market_Dashboard)** · `Power BI` `SQL` `Python`
...
**[Mortality Forecasting for Insurance Risk](https://github.com/Rahdin/LSTM-based-mortality-forecasting)** · `Python` `R` `PyTorch` `StMoMo`
...
**[Patient Activity Analysis & Forecasting](https://github.com/Rahdin/schizophreniamotorpatternmodelling)** · `SQL` `Python` `PostgreSQL`
...
**[Real-Time Fraud Detection](https://github.com/Rahdin/Real_Time_Fraud_Detection)** · `Python` `FastAPI` `Redis`
...
**[Social Media Application](https://github.com/Rahdin/Social-Media-App)** · `Java`
...
**Analytics & BI**&nbsp;&nbsp;Power BI · Tableau · Excel · DAX · Microsoft Power Platform
**Languages & Databases**&nbsp;&nbsp;SQL (SQL Server · PostgreSQL · MySQL) · Python · R · Java · JavaScript · Scala
**Data & Statistics**&nbsp;&nbsp;Pandas · NumPy · scikit-learn · XGBoost · PySpark · time-series forecasting · statistical modeling
**Engineering & Tools**&nbsp;&nbsp;FastAPI · React · Node.js · Git · Docker · Azure · AWS

---

## Reach me

[LinkedIn](https://www.linkedin.com/in/rahdin-zaman-254822180/) · rahdin.zaman@mail.utoronto.ca · Toronto, ON
